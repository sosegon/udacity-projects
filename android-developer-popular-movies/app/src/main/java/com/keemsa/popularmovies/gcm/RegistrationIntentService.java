 ...
 * based on https://github.com/udacity/Advanced_Android_Development/blob/3e857821a6c8520e2f29c05e76ec8c36ad50dcb2/app/src/main/java/com/example/android/sunshine/app/gcm/RegistrationIntentService.java
 */
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                sharedPreferences.edit().putBoolean(CatalogActivity.SENT_TOKEN_TO_SERVER, true).apply();
            }
        } catch (Exception e) {
            ...
            sharedPreferences.edit().putBoolean(CatalogActivity.SENT_TOKEN_TO_SERVER, false).apply();
        }
    }
