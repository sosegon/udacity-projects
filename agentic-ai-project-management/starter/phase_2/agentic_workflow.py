...
with open('Product-Spec-Email-Router.txt') as f: specs = f.read()
...
persona_product_manager = "You are an evaluation agent that checks the answers of other worker agents"
...
# For the 'agent_to_evaluate' parameter, refer to the provided solution code's pattern.
evaluation_criteria_dev_manager = """
    The answer should be tasks following this exact structure: \n
    Task ID: A unique identifier for tracking purposes\n
    Task Title: Brief description of the specific development work\n
    Related User Story: Reference to the parent user story\n
...
agents = [
    {
        ...
        "description": """
            ...
            Does not define features or tasks.
            Does not group stories"
        """,
    ...
    },
    {
        ...
        "description": """
            Responsible for defining product features only.
            Does not define personas or tasks.
            Does not group features"
        """,
    ...
    },
    {
        ...
        "description": """
            Responsible for defining tasks only.
            Does not define personas or features.
