...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws JSONException {
        ...
        try {
            ...
            // Display what was stored with bulkInsert
    ...
    private String formatHighLows(double high, double low) {
        ...
        String units = pref.getString(mContext.getString(R.string.prf_units_key), mContext.getString(R.string.prf_units_default));
        if (units.equals(mContext.getString(R.string.prf_units_imperial))) {
            high = (9 * high / 5) + 32;
            low = (9 * low / 5) + 32;
        } else if (!units.equals(mContext.getString(R.string.prf_units_imperial))) {
